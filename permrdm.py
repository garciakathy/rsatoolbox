...
layer2 = np.load('isiktoolbox/data/rdms/AlexNet/features.3.npz')['arr_0']
layer3 = np.load('isiktoolbox/data/rdms/AlexNet/features.6.npz')['arr_0']
layer4 = np.load('isiktoolbox/data/rdms/AlexNet/features.8.npz')['arr_0']
layer5 = np.load('isiktoolbox/data/rdms/AlexNet/features.10.npz')['arr_0']
